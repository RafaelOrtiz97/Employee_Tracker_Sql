        ...
        if (answers.prompt === 'View All Department') {
            ...
            db.query(`SELECT * FROM department`, (err, result) => {
                ...
                inquirer.prompt([
                    ...
                    db.query(`INSERT INTO role (title, salary, department_id) VALUES (?, ?, ?)`, [answers.role, answers.salary, department.department_id], (err, result) => {
                        if (err) throw err;
            ...
            db.query(`SELECT * FROM employee, role`, (err, result) => {
                ...
                inquirer.prompt([
                    ...
                    db.query(`INSERT INTO employee (first_name, last_name, role_id, department_id, salary, manager) VALUES (?, ?, ?, ?, ?, ?)`, [answers.firstName, answers.lastName, role.role_id, role.department_id, role.salary, answers.manager], (err, result) => {
                        if (err) throw err;
